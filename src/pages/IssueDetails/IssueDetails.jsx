      ...
      <div className="flex justify-between border p-10 rounded-lg">
        <ScrollArea className="h-[78vh] w-[70%]">
          <div>
            ...
            <h1 className="text-lg font-semibold text-gray-400 mt-5">
              Issue title: {issueDetails?.title.toUpperCase()}
            </h1>
            <div className="py-5">
              <h2 className="font-semibold">Description</h2>
              <p className="text-sm text-gray-400 mt-3">{issueDetails?.description}</p>
            </div>
            <div className="mt-5">
              ...
              <Tabs defaultValue="comments" className="w-[450px]">
                ...
                <TabsContent value="history">history Make changes to your account here</TabsContent>
              </Tabs>
            </div>
          </div>
        </ScrollArea>
            ...
            <div className="p-5">
              <div className="space-y-7">
                <div className="flex gap-10 items-center">
                  ...
                  {issueDetails && issueDetails.assignee ? (
